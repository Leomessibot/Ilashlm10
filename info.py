...
CHATS = [int(cht) if id_pattern.search(cht) else cht for cht in environ.get('CHATS', '').split()]
...
GROUPS = [int(groups) if id_pattern.search(groups) else groups for groups in environ.get('GROUPS', '').split()]
